...
-(void)viewDidLayoutSubviews{
    ...
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@%@",myURL,self.user.image]];
    [imageView sd_setImageWithURL:url];
    [self.headBtn setImage:imageView.image forState:UIControlStateNormal];
    self.briefLable.text = self.user.brief;
}
